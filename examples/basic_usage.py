...
class CTraderExample:
    ...
    def __init__(self, client_id: str, client_secret: str, access_token: str, is_live: bool = False):
...
async def main():
    ...
    if CLIENT_ID == "your_client_id":
        logger.error("Пожалуйста, укажите ваши реальные CLIENT_ID, CLIENT_SECRET и ACCESS_TOKEN")
        return
