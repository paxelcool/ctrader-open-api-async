...
class AsyncClient:
    ...
    async def start_service(self) -> None:
        ...
        self.protocol = AsyncTcpProtocol(
            self.host, self.port, messages_per_second=self.messages_per_second
        )
    ...
    # Базовые методы
    async def send_application_auth_req(
        self, client_id: str, client_secret: str, client_msg_id: Optional[str] = None
    ) -> ProtoMessage:
    ...
    async def send_version_req(
        self, client_msg_id: Optional[str] = None
    ) -> ProtoMessage:
        """Запрос версии API."""
    ...
    async def send_get_account_list_by_access_token_req(
        self, access_token: str, client_msg_id: Optional[str] = None
    ) -> ProtoMessage:
    ...
    async def send_account_auth_req(
        self,
    ...
    async def send_account_logout_req(
        self, ctid_trader_account_id: int, client_msg_id: Optional[str] = None
    ) -> ProtoMessage:
    ...
    async def send_asset_class_list_req(
        self, ctid_trader_account_id: int, client_msg_id: Optional[str] = None
    ) -> ProtoMessage:
    ...
    async def send_symbol_category_list_req(
        self, ctid_trader_account_id: int, client_msg_id: Optional[str] = None
    ) -> ProtoMessage:
    ...
    async def send_symbols_list_req(
        self,
        ctid_trader_account_id: int,
    ...
    async def send_symbol_by_id_req(
        self,
        ctid_trader_account_id: int,
        symbol_id: int,
        client_msg_id: Optional[str] = None,
    ...
    async def send_subscribe_spots_req(
        self,
        ctid_trader_account_id: int,
        symbol_ids: list,
        client_msg_id: Optional[str] = None,
    ...
    async def send_unsubscribe_spots_req(
        self,
        ctid_trader_account_id: int,
        symbol_ids: list,
        client_msg_id: Optional[str] = None,
    ...
    async def send_subscribe_live_trendbar_req(
        self,
        ctid_trader_account_id: int,
        period: int,
        symbol_id: int,
    ...
    async def send_unsubscribe_live_trendbar_req(
        self,
        ctid_trader_account_id: int,
        period: int,
        symbol_id: int,
    ...
    async def send_get_trendbars_req(
        self,
        ctid_trader_account_id: int,
        from_timestamp: int,
        to_timestamp: int,
    ...
    async def send_get_tick_data_req(
        self,
        ctid_trader_account_id: int,
        from_timestamp: int,
        to_timestamp: int,
    ...
    async def send_cancel_order_req(
        self,
        ctid_trader_account_id: int,
        order_id: int,
        client_msg_id: Optional[str] = None,
    ...
    async def send_amend_order_req(
        self,
        ctid_trader_account_id: int,
        order_id: int,
    ...
    async def send_close_position_req(
        self,
        ctid_trader_account_id: int,
        position_id: int,
        volume: int,
    ...
    async def send_amend_position_stop_loss_req(
        self,
        ctid_trader_account_id: int,
        position_id: int,
        stop_loss: Optional[float] = None,
    ...
    async def send_amend_position_take_profit_req(
        self,
        ctid_trader_account_id: int,
        position_id: int,
        take_profit: Optional[float] = None,
    ...
    async def send_order_details_req(
        self,
        ctid_trader_account_id: int,
        order_id: int,
        client_msg_id: Optional[str] = None,
    ...
    async def send_get_position_unrealized_pnl_req(
        self, ctid_trader_account_id: int, client_msg_id: Optional[str] = None
    ) -> ProtoMessage:
    ...
    def create_demo_client(cls, messages_per_second: int = 5) -> "AsyncClient":
        ...
        return cls(
            EndPoints.PROTOBUF_DEMO_HOST, EndPoints.PROTOBUF_PORT, messages_per_second
        )
    ...
    def create_live_client(cls, messages_per_second: int = 5) -> "AsyncClient":
        ...
        return cls(
            EndPoints.PROTOBUF_LIVE_HOST, EndPoints.PROTOBUF_PORT, messages_per_second
        )
