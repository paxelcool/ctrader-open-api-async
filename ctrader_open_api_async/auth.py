...
class AsyncAuth:
    ...
    def get_auth_uri(self, scope: str = "trading", base_uri: str = EndPoints.AUTH_URI) -> str:
    ...
    async def get_token(self, auth_code: str, base_uri: str = EndPoints.TOKEN_URI) -> Dict[str, Any]:
    ...
    async def refresh_token(self, refresh_token: str, base_uri: str = EndPoints.TOKEN_URI) -> Dict[str, Any]:
    ...
    async def validate_token(self, access_token: str) -> bool:
        ...
        return bool(access_token and isinstance(access_token, str) and len(access_token) > 10) 